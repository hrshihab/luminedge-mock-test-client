    ...
    <div className="flex flex-col w-full">
      <div className="flex items-center justify-between p-4">
        ...
        <Link href="/" className="flex items-center">
          ...
          <span className="text-lg font-bold">Lumiedge</span>
        </Link>
      </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white rounded-lg p-4 w-3/4 max-w-sm">
            <ul className="menu">
              ...
              <li
                className={`hover:bg-[#FACE39] hover:text-black rounded-r-2xl ${
                  pathname === "/admin/create-schedule"
                    ? "bg-[#FACE39] font-bold text-black"
                    : ""
                }`}
              >
              ...
              >
                <Link href="/admin/available-schedules">
