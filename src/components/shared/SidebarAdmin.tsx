      ...
      <ul className="menu  min-h-screen rounded-box">
        <li
          className={`hover:bg-[#FACE39] hover:text-black rounded-full ${
            pathname === "/admin" ? "bg-[#FACE39] text-black font-bold" : ""
          }`}
        >
          <Link href="/admin">
            <svg
        ...
        <li
          className={`hover:bg-[#FACE39] hover:text-black rounded-full ${
            pathname.toLowerCase() === "/admin/create-schedule"
              ? "bg-[#FACE39] text-black font-bold"
              : ""
          }`}
        >
          <Link href="/admin/create-schedule">
        ...
        <li
          className={`hover:bg-[#FACE39] hover:text-black rounded-full ${
            pathname.toLowerCase() === "/admin/enrolled-students"
              ? "bg-[#FACE39] text-black font-bold"
              : ""
          }`}
        >
          <Link href="/admin/enrolled-students">
        ...
        <li
          className={`hover:bg-[#FACE39] hover:text-black rounded-full ${
            pathname.toLowerCase() === "/admin/view-schedule"
              ? "bg-[#FACE39] text-black font-bold"
              : ""
          }`}
        >
          <Link href="/admin/view-schedule">
        ...
        <li
          className={`hover:bg-[#FACE39] hover:text-black rounded-full ${
            pathname.toLowerCase() === "/admin/files"
              ? "bg-[#FACE39] text-black font-bold"
              : ""
          }`}
        >
        ...
        <li
          className={`hover:bg-[#FACE39] hover:text-black rounded-full ${
            pathname.toLowerCase() === "/admin/reports"
              ? "bg-[#FACE39] text-black font-bold"
              : ""
          }`}
        >
